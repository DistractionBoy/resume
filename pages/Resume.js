    ...
    <Layout pageMetaData={metaData} >
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="mi-about-content">
                ...
                <p>
                  I am a UI Developer and Photographer, with a background freelancing 
                  in design and video. I build beautiful and accessible websites and can
      ...
      <div className="mi-resume-area mi-section mi-padding-top mi-padding-bottom">
        <div className="container">
          ...
          <Smalltitle title="Working Experience" icon="fa fa-briefcase" />
          ...
          <Smalltitle title="Educational Qualifications" icon="fa fa-book" />
          <div className="mi-resume-wrapper">
